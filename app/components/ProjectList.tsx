...
export default function ProjectList({name, description, link}: ProjectList){
    return(
        <div className="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-85 p-6 transition delay-60 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500">
